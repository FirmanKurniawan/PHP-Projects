<?php
	...
	if(isset($_POST['Update'])) {
		...
		$result = mysqli_query($db, "UPDATE aset_aula SET 
			nama_aset = '$nama_aset',
			alokasi = '$alokasi',
			kuantitas = '$kuantitas',
			harga = '$harga',
...
<?php
	...
	$result = mysqli_query($db, "SELECT * FROM aset_aula WHERE id=$id");
?>
	...
	<div class="content-container">
		<ol class="breadcrumb">
		   	...
		   	<li class="breadcrumb-item"><a href="#">Aset Aula</a></li>
				...
				<form action="edit.php" method="post" name="update">
					<?php foreach($result as $data) { ?>
				  	...
				  	<div class="form-group">
				    	...
				    	<input type="text" class="form-control" name="alokasi" value="Aula" readonly>
				  	</div>
				  	<div class="form-row">
				    	<div class="col pl-1">
				    		<div class="form-group">
