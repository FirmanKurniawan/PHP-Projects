<?php
	...
	if(isset($_GET['cari'])) {
		$cari = $_GET['cari'];
		$result = mysqli_query($db, "SELECT * FROM aset_aula WHERE nama_aset LIKE '%".$cari."%'");
	} else {
		$result = mysqli_query($db, "SELECT * FROM aset_aula ORDER BY id DESC");
	}
...
?>
	...
	<div class="content-container">
		<ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">Aset Aula</li>
		</ol>

		<div class="content shadow">
			<div class="isi">
				<h4>Daftar Aset Aula</h4>
				<a href="cetak.php" target="_blank" class="float-right mt-4 btn btn-outline-info">Cetak PDF</a>
				<hr>
				<form action="index.php" method="get">
					<div class="form-row">
					    <div class="col-3 pl-0">
					      <input type="text" class="form-control" placeholder="Cari Aset Aula...">
					    </div>
					    <div class="col">
