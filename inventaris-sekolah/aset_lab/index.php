<?php
	...
	if(isset($_GET['cari'])) {
		$cari = $_GET['cari'];
		$result = mysqli_query($db, "SELECT * FROM aset_lab WHERE nama_aset LIKE '%".$cari."%'");
	} else {
		$result = mysqli_query($db, "SELECT * FROM aset_lab ORDER BY id DESC");
	}
