<?php
	...
	if(isset($_POST['Update'])) {
		...
		$result = mysqli_query($db, "UPDATE aset_kantor SET 
			nama_aset = '$nama_aset',
			alokasi = '$alokasi',
			kuantitas = '$kuantitas',
			harga = '$harga',
...
<?php
	...
	$result = mysqli_query($db, "SELECT * FROM aset_kantor WHERE id=$id");
?>
	...
	<div class="content-container">
		<ol class="breadcrumb">
		   	...
		   	<li class="breadcrumb-item"><a href="#">Aset Kantor</a></li>
