<?php
	...
	if(isset($_GET['cari'])) {
		$cari = $_GET['cari'];
		$result = mysqli_query($db, "SELECT * FROM aset_kantor WHERE nama_aset LIKE '%".$cari."%'");
	} else {
		$result = mysqli_query($db, "SELECT * FROM aset_kantor ORDER BY id DESC");
	}
...
?>
	...
	<div class="content-container">
		<ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">Aset Kantor</li>
		</ol>

		<div class="content shadow">
			<div class="isi">
				<h4>Daftar Aset Kantor</h4>
