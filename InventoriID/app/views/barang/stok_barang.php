...
$query_stok = query("SELECT * FROM tb_stok_barang");

// Tombol search ditekan
if (isset($_POST["cariBarang"])) {
    $query_stok = cariBarang($_POST["keyword"]);
}
?>
            ...
            <table class="table table-danger table-striped table-bordered border-danger" style="text-align: center; vertical-align: middle;">
                ...
                <?php foreach ($query_stok as $row) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="ubah_barang.php?id_stok=<?= $row["id_stok"]; ?>">
                            ...
                            <a href="hapus_barang.php?id_stok=<?= $row["id_stok"]; ?>" id="btn-hapus">
                                <button type="button" class="btn btn-sm btn-danger btn-outline-warning">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="stok_barang" placeholder="Masukkan Stok Barang" required>
                                </div>
                            </div>
