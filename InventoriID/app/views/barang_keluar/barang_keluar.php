...
$query_barang = query("SELECT * FROM tb_barang_keluar");
        ...
        <div class="table-responsive">
            <table class="table table-danger table-striped table-bordered border-danger" style="text-align: center; vertical-align: middle;">
                ...
                <?php foreach ($query_barang as $row) :
                    ...
                    $date = new DateTime($tanggal_keluar); ?>
                    <tr>
                        <td><?= $i++; ?></td>
                        <td><?= $row["kd_barang_keluar"]; ?></td>
                        <td><?= $row["nama_barang_keluar"]; ?></td>
                        <td><?= $row["jenis"]; ?></td>
                        <td><?= $row["jumlah_keluar"]; ?></td>
                        <td><?= $date->format('d-m-Y'); ?></td>
                        <td><?= $date->format('H:i:s'); ?></td>
                        <td>
                            <a href="ubah_barang_keluar.php?id_barang_keluar=<?= $row["id_barang_keluar"]; ?>">
                            ...
                            <a href="hapus_barang_keluar.php?id_barang_keluar=<?= $row["id_barang_keluar"]; ?>" id="btn-hapus">
                                <button type="button" class="btn btn-sm btn-danger btn-outline-warning">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="POST">
                            <div class="mb-2">
                                <label for="kd_barang_keluar" class="form-label">Kode Barang Keluar</label>
                                <input type="text" class="form-control" name="kd_barang_keluar" placeholder="Masukkan kode barang" required>
                            </div>
                            <div class="mb-2">
                                <label for="nama_barang_keluar" class="form-label">Nama Barang</label>
                                <input type="text" class="form-control" name="nama_barang_keluar" placeholder="Masukkan nama barang" required>
                            </div>
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="jumlah_keluar" placeholder="Masukkan jumlah" required>
                                </div>
                            </div>
