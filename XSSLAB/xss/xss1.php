    ...
    <div class="container atas">
        <div class="row justify-content-center">
            <div class="col-md-5 xss">
                ...
                <br>
                <b><a href="xss2.php">Next Level</a></b>
            </div>
            ...
            <div class="col-md-5">
                ...
                <table class="table table-borderless table-light info text-center">
                        ...
                        <?php
                            ...
                            $result = mysqli_query($db,"SELECT username FROM solved WHERE solved_level = 'LEVEL1'");
                            $jumlah = mysqli_num_rows($result);
                            $total = ceil($jumlah/$batas);

                            $data_user = mysqli_query($db, "SELECT username FROM solved WHERE solved_level = 'LEVEL1' LIMIT $halaman_awal, $batas");
                            $no = $halaman_awal+1;
    ...
    <script>
        ...
        function check() {
            ...
            if (y.value === "<script>alert(document.URL)<\/script>") {
                alert("The flag is : YABUREKABURE");
            } 
        }

        function flag() {
            var z = document.getElementById("cekflag");
            if (z.value != "YABUREKABURE") {
                alert("Wrong flag!");
            }
        }
    </script>   
