...
?>
    ...
    <div class="container atas">
        <div class="row justify-content-center">
            <div class="col-md-5 xss">
                <h2 class="text-center">XSS Level 5</h2>
                <p>Try to alert using <b>document.URL</b></p>
                <button class="btn btn-primary mb-3" onclick="func()">Clue</button>
                <p id="clue" style="display:none">Use &lt;/script&gt; when input inside &lt;script&gt; tags</p>
                ...
                <b><a href="xss4.php" class="previous">Previous Level</a></b>
            </div>
            ...
            <div class="col-md-5">
                ...
                <table class="table table-borderless table-light info text-center">
                        ...
                        <?php
                            ...
                            $result = mysqli_query($db,"SELECT username FROM solved WHERE solved_level = 'LEVEL5'");
                            $jumlah = mysqli_num_rows($result);
                            $total = ceil($jumlah/$batas);

                            $data_user = mysqli_query($db, "SELECT username FROM solved WHERE solved_level = 'LEVEL5' LIMIT $halaman_awal, $batas");
                            $no = $halaman_awal+1;
    ...
    <script>
        ...
        function check() {
            ...
            if (y.value === "</script><script>alert(document.URL)<\/script>") {
                alert("The flag is : OKEHBANGJAGO");
            }
        }

        function flag() {
            var z = document.getElementById("cekflag");
            if (z.value != "OKEHBANGJAGO") {
                alert("Wrong flag!");
            }
        }
    </script>
